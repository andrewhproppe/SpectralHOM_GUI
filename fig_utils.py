...
def make_colors(ncolors, palette="icefire", deletion_indices=[4, 5]):
    colors = np.array(color_palette(palette, ncolors + 2))
    colors = np.delete(colors, deletion_indices, axis=0)
    return colors
...
def set_font_size(size, legend=0):
    plt.rc('font', size=size)  # controls default text sizes
    plt.rc('axes', titlesize=size)  # fontsize of the axes title
    plt.rc('axes', labelsize=size)  # fontsize of the x and y labels
    plt.rc('xtick', labelsize=size)  # fontsize of the tick labels
    plt.rc('ytick', labelsize=size)  # fontsize of the tick labels
    plt.rc('legend', fontsize=size-legend)  # legend fontsize
...
def dress_fig(fig=None, ticks=True, legend=True, frameon=False, tight=False, lgnd_cols=1, **kwargs):
